...
public class MethodCallback
{
    ...
    init(_ aOnStopFaceDetection: @escaping ()->(),_ aOnStartFaceDetection: @escaping ()->(),_ aOnScreenBright: @escaping (Int)->(),_ aOnSetFaceDetectionHintText: @escaping (String,String,String)->())
    {
